...
SECRET_KEY = "django-insecure-f0^=m32h5nav)u4v-lg%neha3a9+%&f#5kjx)q7_9cv(^+!2!l"
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # or specify the path to your app's templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = "static/"
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # Path to store static files
